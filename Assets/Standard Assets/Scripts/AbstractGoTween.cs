...
public abstract class AbstractGoTween
{
	...
	public bool isLoopingBackOnPingPong => _isLoopingBackOnPingPong;
	...
	public virtual void reverse()
	{
		...
		_completedIterations = ((!isReversed) ? Mathf.FloorToInt(_totalElapsedTime / duration) : Mathf.CeilToInt(_totalElapsedTime / duration));
	...
	public virtual void complete()
	{
		if (iterations >= 0)
		{
			goTo((!isReversed) ? totalDuration : 0f, skipDelay: true);
		}
	}

	public void goTo(float time)
	{
		goTo(time, skipDelay: true);
	}
