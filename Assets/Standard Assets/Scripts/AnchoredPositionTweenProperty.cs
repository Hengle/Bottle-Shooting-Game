...
public class AnchoredPositionTweenProperty : AbstractTweenProperty
{
	...
	public override void prepareForUse()
	{
		...
		{
			_startValue = ((!_isRelative) ? _endValue : (_endValue + _target.anchoredPosition));
	...
	public override void tick(float totalElapsedTime)
	{
		...
		Vector2 anchoredPosition = GoTweenUtils.unclampedVector2Lerp(_startValue, _diffValue, value);
