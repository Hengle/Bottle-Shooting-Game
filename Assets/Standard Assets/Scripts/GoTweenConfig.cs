...
public class GoTweenConfig
{
	...
	public List<AbstractTweenProperty> tweenProperties => _tweenProperties;
	...
	{
		RotationQuaternionTweenProperty item = new RotationQuaternionTweenProperty(endValue, isRelative, useLocalRotation: true);
		_tweenProperties.Add(item);
		return this;
	}
	...
	{
		OffsetTweenProperty item = new OffsetTweenProperty(endValue, isRelative, useMax: true);
		_tweenProperties.Add(item);
		return this;
	}
